...
public sealed class CryptoString
{
    ...
    private static byte[] savedKey = { 0, 99, 2, 34, 94, 5, 6, 89, 209, 50, 10,
        103, 120, 201, 114, 15, 16, 200, 254, 19, 20, 21, 90, 99 }; //ASCIIEncoding.UTF8.GetBytes("YOURVALHERE");
    private static byte[] savedIV = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF, 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF };  //ASCIIEncoding.UTF8.GetBytes("TheAmazingClumsyEatingTheFuckOnki"); //
