...
/*  2007-07-26          Sir John E. Boucher     Modified to use System.Collections.Generic.Stack<Operator>    */
/*  2009-01-29          Sir John E. Boucher     Revisited and updated some of the comments                    */
/*                                                                                                            */
/**************************************************************************************************************/
...
# region InfixToRpn method
        ...
        */
        ...
        )
        {
            ...
            {
                throw ( new System.ArgumentException ( "Subject is null or empty" , "Subject" ) ) ;
            }
        ...
        private class OperatorStack : System.Collections.Generic.Stack<Operator>
        {
            ...
            */
            ...
            )
            {
                ...
                if ( Op.Precedence == OperatorPrecedence.Highest )
                {
                    result.Append ( "0" ) ;
                }
                ...
                ( 
                    ( this.Count > 0 ) 
                && 
                    ( this.Peek().Precedence >= Op.Precedence ) 
                )
                {
